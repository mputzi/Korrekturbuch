...
public class KlasseNeu1 extends JDialog implements ActionListener {
	...
	public static void main(String[] args) {
		try {
			KlasseNeu1 dialog = new KlasseNeu1(null);
	 ...
	 * Create the dialog.
	 */
	public KlasseNeu1(final Frame aufrufer) {
		setResizable(false);
	...
	private ListDataListener ListDL = new ListDataListener(){
		...
		public void intervalAdded(ListDataEvent arg0) {
			...
			System.out.print(name_list);System.out.print(name_list_neu);
	...
	private void actionOKButton(){
		...
		// Dialog abbauen
		KlasseNeu1.this.setVisible(false);
		KlasseNeu1.this.dispose();
